...
class TTSFactory:
    ...
    def get_tts_engine(engine_type, **kwargs) -> Type[TTSInterface]:
        if engine_type == "azure_tts":
        ...
        elif engine_type == "bert_vits2_tts":
            from .bert_vits2_tts import TTSEngine as BertVITS2TTSEngine
            ...
            return BertVITS2TTSEngine(
                ...
                line_split=kwargs.get("line_split"),
                split_interval=kwargs.get("split_interval"),
                use_style_text=kwargs.get("use_style_text"),
                style_text=kwargs.get("style_text"),
                style_text_weight=kwargs.get("style_text_weight"),
